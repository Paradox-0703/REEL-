      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl items-center justify-center">
        <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl shadow-black/30 backdrop-blur">
          <div className="mb-8 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-orange-400">Welcome back</p>
            <h1 className="mt-2 text-3xl font-semibold">User login</h1>
            <p className="mt-2 text-sm text-slate-400">Access your account and continue exploring.</p>
          </div>
